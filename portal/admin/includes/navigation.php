                                    ...
                                    <a href="make_action.php?id=<?php echo $row['id'];?>"> 
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details">They is a <?php echo $row['case_severity'] ?> emergency at <span class="noti-title"><?php echo $row['region'] ?>, <?php echo $row['state'] ?></span><span class="noti-time"><?php echo $row['agency_name'] ?></span></p>
