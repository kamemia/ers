                     ...
                     <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Region</label>
                                        <input class="form-control" type="text"  value="<?php echo $row['region']; ?>" readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Longitude</label>
                                        <input class="form-control" type="text"  value="<?php echo $row['longitude']; ?>" readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Latitude</label>
                                        <input class="form-control" type="text"  value="<?php echo $row['latitude']; ?>" readonly="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select" name="officer">
                                            <option value="<?php echo $row['officer']; ?>"><?php echo $row['officer']; ?></option>
                                            <option value="John Doe-0123">John Doe-0123</option>
                                            <option value="Jane DOe-1213">Jane Doe-1213</option>
                                        </select>
                                </div>
                            ...
                            <a href="<?php echo $row['mapLink']; ?>" target="_blank">
                                <button type="button" class="btn btn-primary submit-btn">Open Google Map</button>
                            </a>
                            </div>
